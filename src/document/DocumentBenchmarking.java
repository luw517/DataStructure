...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		int start = 50000;
		long starttimeBasic;
		long starttimeEfficient;
		long endtimeBasic;
		long endtimeEfficient;
		long Basictime;
		long Efficienttime;
				...
				numToCheck += increment)
		{
			...
			starttimeBasic=System.currentTimeMillis();
			for (int i=0; i<=trials; i++) {
				BasicDocument Basic=new BasicDocument(str);
				Basic.getFleschScore();
			  	
			}
			endtimeBasic=System.currentTimeMillis();
			Basictime=endtimeBasic-starttimeBasic;
			System.out.print(Basictime+"\t");
			starttimeEfficient=System.currentTimeMillis();
			for (int i=0; i<=trials; i++) {
				EfficientDocument Efficient=new EfficientDocument(str);
				Efficient.getFleschScore();
			  	
			}
			endtimeEfficient=System.currentTimeMillis();
			Efficienttime=endtimeEfficient-starttimeEfficient;
