...
public class AutoCompleteDictionaryTrie implements  Dictionary, AutoComplete {
     ...
     */@Override
     public List<String> predictCompletions(String prefix, int numCompletions) 
     {
         ...
         List<Character> children = new LinkedList<Character>(stem.getValidNextCharacters());
    	 
    	 for (int i = 0; i < children.size(); i++) {
    		 char ch = children.get(i);
    		 q.add(stem.getChild(ch));
    	 }
    	 ...
    	 while (!q.isEmpty() & numCompletions>=0) {
    		 ...
    		 numCompletions--;
    		 List<Character> childrennew=new LinkedList<Character>(curr.getValidNextCharacters());
    		 for (int i = 0; i < childrennew.size(); i++) {
        		 char chnew = childrennew.get(i);
        		 q.add(curr.getChild(chnew));
        	 }
    	 }
        return completions;
     }
